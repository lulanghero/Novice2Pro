...
# 指定Parquet文件路径
GRAPHRAG_FOLDER="D:/rag_project/GraphRAG/ragtest/inputs/artifacts"


# 数据库连接相关参数配置
NEO4J_URI="neo4j+s://aa3819f7.databases.neo4j.io"
NEO4J_USERNAME="neo4j"
NEO4J_PASSWORD="gBOLCtlM2Lfk1ozbwHCqTwgv6lefTL_CQibyu-xPbWI"
