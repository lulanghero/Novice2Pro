...
INPUT_DIR = "D:/Novice2Pro/ragtest/inputs/artifacts"
...
async def setup_llm_and_embedder():
    ...
    llm = ChatOpenAI(
        ...
        # 调用本地大模型  通过Ollama
        api_base="http://127.0.0.1:3000/v1",  # 请求的API服务地址
        api_key="sk-ZRHEyQNBc1We65Nt3eEaD9062cE24cC9B0383407A51067B2",  # API Key
        model="qwen-plus",  # 本次使用的模型
        api_type=OpenaiApiType.OpenAI,
    )
